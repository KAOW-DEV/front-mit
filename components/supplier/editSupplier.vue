  ...
  <div>
    <v-card>
      <v-card-title primary-title>
        <v-icon color="success" large>mdi-account-edit</v-icon>
        <v-spacer></v-spacer>
        <v-divider vertical class="mx-3"></v-divider>
        <v-btn class="" color="error" @click="$emit('closeDialogEditSupplier')">
      ...
      <v-card-text>
        <v-row>
          ...
          <v-col cols="6">
            <v-btn color="error" class="float-end" @click="deleteConfirm">
          ...
          this.$swal
            ...
            .then((result) => {
              if (result.isConfirmed) {
                ...
                this.$emit("openDialogEditSupplier");
              }
            });
        });
      }
