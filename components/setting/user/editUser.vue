      ...
      <v-card>
        ...
        <v-toolbar>
          ...
          <v-btn
            ...
            color="red"
            dark
            @click="$emit('closeDialogEditUser')"
            >ยกเลิก</v-btn
          >
          <v-spacer></v-spacer>
        </v-toolbar>
...
export default {
  ...
  methods: {
    ...
    async checkSave() {
      if (this.itemUser.password != null) {
        ...
        if (pass.match(pwdPolicy)) {
          this.$swal({
            ...
            if (result.isConfirmed) {
              this.$emit("closeDialogEditUser");

              if (this.itemUser.password != null) {
                this.updateUser();
              } else {
                this.updateUserNoPassword();
              }
            }
          });
        } else {
