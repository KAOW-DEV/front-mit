    ...
    <form @submit.prevent="checkSave">
      <v-card>
        <v-card-title primary-title>
          เพิ่มข้อมูลหน่วยนับ
          <v-spacer></v-spacer>
          <v-btn icon @click="$emit('closeDialogAddUnit')">
        ...
        <v-card-actions>
          ...
          <v-btn color="error" @click="$emit('closeDialogAddUnit')">ปิด</v-btn>
          <v-spacer></v-spacer>
        </v-card-actions>
      </v-card>
    </form>
